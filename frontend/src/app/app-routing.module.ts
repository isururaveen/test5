...
import { EditShippinginfoComponent } from './components/checkout/edit-shippinginfo/edit-shippinginfo.component';
...
const routes: Routes = [
  ...
  { path: 'checkout', component: CheckoutComponent, data: {title: 'Check out'},
    children: [
      ...
      { path: 'update/:id', component: EditShippinginfoComponent,  data: {title: 'Edit Shipping'} },
    ]
  },
